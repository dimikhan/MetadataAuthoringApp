...
public class CloudantClientMgr_MetaData {
	...
	private static void initClient() {
		...
		if ( cloudant == null ) {
			synchronized (CloudantClientMgr_MetaData.class) {
				if ( cloudant != null ) {
					return;
				}				
	...
	public static Database getDB(String sDBName) {
	...
	public static CloudantClient getCloudantClient()
	{
		return cloudant;
	}
	
	private CloudantClientMgr_MetaData() {
